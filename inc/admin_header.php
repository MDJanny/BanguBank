<div class="pb-32 bg-sky-600">
    <!-- Navigation -->
    <?php
    $navItemDefaultClass = "hover:bg-sky-500 hover:bg-opacity-75";
    $navItemActiveClass = "bg-sky-700";
    ?>
                ...
                <div class="flex items-center px-2 lg:px-0">
                    <div class="hidden sm:block">
                        <div class="flex space-x-4">
                            ...
                            <a href="/admin/index.php" class="px-3 py-2 text-sm font-medium text-white rounded-md
                                <?php if ($page_file == "index.php") echo $navItemActiveClass;
                                else echo $navItemDefaultClass; ?>">Customers</a>
                            <a href="/admin/transactions.php" class="px-3 py-2 text-sm font-medium text-white rounded-md
                                <?php if ($page_file == "transactions.php") echo $navItemActiveClass;
                                else echo $navItemDefaultClass; ?>">Transactions</a>
                        </div>
                    </div>
                </div>
                <div class="hidden gap-2 sm:ml-6 sm:flex sm:items-center">
                    ...
                    <div class="relative ml-3" x-data="{ open: false }">
                            ...
                            <button @click="open = !open" type="button"
                                ...
                                <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-sky-100">
                                    <span class="font-medium leading-none text-sky-700">
                                        <?= getInitialsFromName($admin->getName()) ?>
                                    </span>
                                </span>
                                <!-- <img
                        ...
                        <div x-show="open" @click.away="open = false"
                            ...
                            <a href="/admin/logout.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"
            ...
            <div class="pt-4 pb-3 border-t border-sky-700">
                ...
                <div class="px-2 mt-3 space-y-1">
                    <a href="/admin/logout.php"
                        class="block px-3 py-2 text-base font-medium text-white rounded-md hover:bg-sky-500 hover:bg-opacity-75">Logout</a>
                </div>
            </div>
        </div>
    </nav>
